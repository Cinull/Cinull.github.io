...
function readtext() {
    ...
    var album4 = new Array("带我去找夜生活", "スパークル", "无人的海边", "Perfect", "这是我一生中最勇敢的瞬间", "this is what falling in love feels like", "今夜无法入眠", "岛屿", "orion", "没有名字的夜晚");
    var album5 = new Array("给小裴", "情书", "故事");
